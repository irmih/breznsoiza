...
const StorefrontInstanceContextProvider = props => {
  ...
  const mse = Object(aem_core_cif_react_components_["useStorefrontEvents"])();
...
const ProductRecsGallery_ProductRecsGallery = props => {
  ...
  const mse = Object(aem_core_cif_react_components_["useStorefrontEvents"])();
  const rendered = Object(external_react_["useRef"])(false);
  const {
    showAddToWishList
  } = props;
  const {
