...
const BundleProductOptions = () => {
  ...
  const productId = (_document$querySelect = document.querySelector('[data-cmp-is=product]')) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.id;
  const [bundleState, setBundleState] = Object(external_react_["useState"])(null);
  const intl = Object(external_react_intl_["useIntl"])();
  let {
    sku,
    showAddToWishList
  } = ((_document$querySelect2 = document.querySelector(bundleProductOptionsContainer)) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.dataset) || {};
  ...
  if (!sku) return /*#__PURE__*/external_react_default.a.createElement(external_react_default.a.Fragment, null);
  ...
  return /*#__PURE__*/external_react_default.a.createElement(external_react_default.a.Fragment, null, bundleState.selections.map(e => /*#__PURE__*/external_react_default.a.createElement("section", {
    ...
    className: "required"
  }, " *")), /*#__PURE__*/external_react_default.a.createElement("div", null, renderItemOptions(e)))), /*#__PURE__*/external_react_default.a.createElement("section", {
    className: "productFullDetail__section productFullDetail__bundleProduct"
  }, /*#__PURE__*/external_react_default.a.createElement("h3", null, /*#__PURE__*/external_react_default.a.createElement("span", {
    className: "required"
  }, "* ", intl.formatMessage({
  ...
  }), ": ", getTotalPrice()))), /*#__PURE__*/external_react_default.a.createElement("section", {
    ...
    className: "productFullDetail__cartActions productFullDetail__section"
  }, /*#__PURE__*/external_react_default.a.createElement("button", {
...
/* harmony default export */ var giftCardOptions = (GiftCartOptions);
...
const useAddToCartEvent = (props = {}) => {
  ...
  const [, defaultAddToCartApi] = Cart_useAddToCart();
  const {
    addToCartApi = defaultAddToCartApi
  } = props;
  useEventListener(document, 'aem.cif.add-to-cart', async event => {
    const items = typeof event.detail === 'string' ? JSON.parse(event.detail) : event.detail;
    const physicalCartItems = items.filter(item => !item.virtual).map(useAddToCartEvent_productMapper);
    const virtualCartItems = items.filter(item => item.virtual).map(useAddToCartEvent_productMapper);
    const bundleCartItems = items.filter(item => item.bundle).map(useAddToCartEvent_bundledProductMapper);
